...
const Admincontact = () => {
  ...
  useEffect(() => {
    axios
      .get("https://192.168.1.2:3000/api/Admincontact")
      .then((response) => {
  ...
  const deletecontact = (id) => {
    axios
      .delete(`https://192.168.1.2:3000/api/Admincontact/${id}`)
      .then((response) => {
  ...
  const handleSendEmail = async () => {
    try {
      ...
      await axios.post("https://192.168.1.2:3000/api/email/send-email", emailPayload);
